...
def test_render_points():
    ...
    s.rules.append(r)
    lyr = mapnik.Layer("Places", "epsg:4326")
    lyr.datasource = ds
    ...
    for projdescr in projs:
        ...
        assert num_points_present == num_points_rendered, (
...
def test_render_with_detector():
    ...
    assert actual.to_string("png32") == expected.to_string("png32"), (
...
if "shape" in mapnik.DatasourceCache.plugin_names():
    ...
    def test_render_with_scale_factor():
        ...
        for size in sizes:
            ...
            # Allow tolerance=2 for minor rendering differences (e.g., antialiasing, rounding).
            # Accept a tiny mismatch ratio to reduce platform-specific flakiness.
            images_almost_equal(actual, expected, tolerance=2, max_mismatch_ratio=0.001)
